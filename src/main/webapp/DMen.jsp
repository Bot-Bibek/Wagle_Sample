...
<head>
    ...
    <title>For Him - Value Point</title>
...
<body>
    ...
    <div class="top-navbar">
        ...
        <div class="other-links">
            ...
            <a href = "SigIn.jsp"><i class = "fa-solid fa-cart-shopping"></i></a>
        </div>
    </div>
    <!-- top navbar -->
        ...
        <!-- navbar -->
<!-- <form action="MyDetail.jsp" method = "post">
...
<style>
    ...
    <div class="row" style="margin-top: 30px;">
        <% DatabaseConnection Dc = new DatabaseConnection();
           try {
            ...
            String query = "select * from product_details where product_category=1";
            
            if (request.getParameter("highToLow") != null) {
                query = "SELECT * FROM product_details WHERE product_category = 1 ORDER BY product_price DESC";
            } else if (request.getParameter("lowToHigh") != null) {
                query = "SELECT * FROM product_details WHERE product_category = 1 ORDER BY product_price ASC";
            }
  ...
  <input type="number" id="quantity" name="quantity" min="1" max="<%= product_quantity %>" value="<%= product_quantity %>">
                     <h5>$ <%= product_price %><span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                 </div>
             </div>
         </div>
         <% }
