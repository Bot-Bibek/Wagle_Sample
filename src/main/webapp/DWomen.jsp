...
<head>
    ...
    <title>For Her - Value Point</title>
    ...
    <div class="row" style="margin-top: 30px;">
        <% DatabaseConnection Dc = new DatabaseConnection();
           try {
            ...
            String query = "select * from product_details where product_category=2";
            
            if (request.getParameter("highToLow") != null) {
                query = "SELECT * FROM product_details WHERE product_category = 2 ORDER BY product_price DESC";
            } else if (request.getParameter("lowToHigh") != null) {
                query = "SELECT * FROM product_details WHERE product_category = 2 ORDER BY product_price ASC";
            }
